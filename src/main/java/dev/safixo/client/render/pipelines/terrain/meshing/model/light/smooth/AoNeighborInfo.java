 ...
 */
enum AoNeighborInfo {
    DOWN(new int[] { Direction.WEST, Direction.EAST, Direction.NORTH, Direction.SOUTH }, 0.5F) {
        @Override
        public void calculateCornerWeights(float x, float y, float z, float[] out) {
            final float u = MathExt.clamp(z, 0.0f, 1.0f);
            final float v = MathExt.clamp(1.0f - x, 0.0f, 1.0f);
        ...
        public float getDepth(float x, float y, float z) {
            return MathExt.clamp(y, 0.0F, 1.0F);
        }
    },
    UP(new int[] { Direction.EAST, Direction.WEST, Direction.NORTH, Direction.SOUTH }, 1.0F) {
        @Override
        public void calculateCornerWeights(float x, float y, float z, float[] out) {
            final float u = MathExt.clamp(z, 0.0f, 1.0f);
            final float v = MathExt.clamp(x, 0.0f, 1.0f);
        ...
        @Override
        public float getDepth(float x, float y, float z) {
            return 1.0f - MathExt.clamp(y, 0.0F, 1.0F);
        }
    },
    NORTH(new int[] { Direction.UP, Direction.DOWN, Direction.EAST, Direction.WEST }, 0.8F) {
        @Override
        public void calculateCornerWeights(float x, float y, float z, float[] out) {
            final float u = MathExt.clamp(1.0f - x, 0.0f, 1.0f);
            final float v = MathExt.clamp(y, 0.0f, 1.0f);
        ...
        @Override
        public float getDepth(float x, float y, float z) {
            return MathExt.clamp(z, 0.0F, 1.0F);
        }
    },
    SOUTH(new int[] { Direction.WEST, Direction.EAST, Direction.DOWN, Direction.UP }, 0.8F) {
        @Override
        public void calculateCornerWeights(float x, float y, float z, float[] out) {
            final float u = MathExt.clamp(y, 0.0f, 1.0f);
            final float v = MathExt.clamp(1.0f - x, 0.0f, 1.0f);
        ...
        @Override
        public float getDepth(float x, float y, float z) {
            return 1.0f - MathExt.clamp(z, 0.0F, 1.0F);
        }
    },
    WEST(new int[] { Direction.UP, Direction.DOWN, Direction.NORTH, Direction.SOUTH }, 0.6F) {
        @Override
        public void calculateCornerWeights(float x, float y, float z, float[] out) {
            final float u = MathExt.clamp(z, 0.0f, 1.0f);
            final float v = MathExt.clamp(y, 0.0f, 1.0f);
        ...
        @Override
        public float getDepth(float x, float y, float z) {
            return MathExt.clamp(x, 0.0F, 1.0F);
        }
    },
    EAST(new int[] { Direction.DOWN, Direction.UP, Direction.NORTH, Direction.SOUTH }, 0.6F) {
        @Override
        public void calculateCornerWeights(float x, float y, float z, float[] out) {
            final float u = MathExt.clamp(z, 0.0f, 1.0f);
            final float v = MathExt.clamp(1.0f - y, 0.0f, 1.0f);
        ...
        @Override
        public float getDepth(float x, float y, float z) {
            return 1.0f - MathExt.clamp(x, 0.0F, 1.0F);
        }
    };
    ...
    AoNeighborInfo(int[] directions, float strength) {
     ...
     */
    public static AoNeighborInfo get(int direction) {
        return direction == MeshDirection.GENERIC ? VALUES[Direction.UP] : VALUES[direction];
    }
}
