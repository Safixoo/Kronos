...
public class SouthFaceWriter extends FaceWriterWrapper {
	...
	public void colorizeQuad(BlockRenderer blockRenderer, ModelBoundsData bounds, Block<?> block, int x, int y, int z, int color) {
		blockRenderer.colorizeQuad(block, x, y, z, Direction.SOUTH, 0, 0, 1, 1.0F - bounds.maxZB, 0, 1, 0, bounds.maxYB, bounds.minYB, -1, 0, 0, 1.0F - bounds.minXB, 1.0F - bounds.maxXB, color);
	}
