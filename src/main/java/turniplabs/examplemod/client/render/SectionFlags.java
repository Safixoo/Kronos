...
public class SectionFlags {
	...
	public static final int SOLID_FACES         = 0b000000000111111000000000; // 9b
	...
	public static int getSolidFaces(int flags) {
		return (flags & SOLID_FACES) >>> 9;
	}

	public static int setSolidFaces(int flags, int solidFaces) {
		return (flags & ~SOLID_FACES) | (solidFaces << 9);
	}
